  ...
  return (
    <div className="bg-brand-surface border border-brand-border rounded-xl p-5">
      <div className="flex items-start justify-between">
        ...
        <div
          className={`w-10 h-10 rounded-lg flex items-center justify-center shrink-0 ${iconBg} ${pulse ? 'animate-pulse' : ''}`}
        >
          {icon}
        </div>
      </div>
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex flex-wrap items-center gap-2 mt-1">
          ...
          <span
            className={`text-xs font-semibold ${isCritical ? 'text-red-400 animate-pulse' : 'text-orange-400'}`}
          >
    ...
    <div className="space-y-6 max-w-7xl">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <KpiCard
          ...
          valueClass={
            stats.sla_compliance_pct === null ? 'text-slate-500'
            : stats.sla_compliance_pct >= 80 ? 'text-emerald-400'
            : stats.sla_compliance_pct >= 60 ? 'text-yellow-400'
            : 'text-red-400'
          }
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-brand-surface border border-brand-border rounded-xl p-5 space-y-6">
          <div>
            <h3 className="text-sm font-semibold text-slate-200 mb-3">{t('dashboard.byClient.title')}</h3>
      ...
      <div
        className={`grid gap-6 ${stats.overdue_tickets.length > 0 && stats.unassigned_tickets.length > 0 ? 'grid-cols-1 lg:grid-cols-2' : 'grid-cols-1'}`}
      >
